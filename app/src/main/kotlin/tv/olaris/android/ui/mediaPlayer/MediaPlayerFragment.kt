...
class MediaPlayerFragment :
    BaseFragment<FragmentFullScreenMediaPlayerBinding>(FragmentFullScreenMediaPlayerBinding::inflate) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d(TAG, "Creating view, arguments Server: ")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getStreamingUrl(uuid).observe(viewLifecycleOwner) { streamingUrl ->
